...
/**
 * POST /api/groups/:group_id/clips/:clip_id/:user_id - fake clip
 */
describe('POST /api/groups/'+group4+'/clips/'+fakeclip+'/'+user2+'?access_token='+access_token, function(){
...
/**
 * POST /api/groups/:group_id/clips/:clip_id/:user_id - not author of clip
 */
describe('POST /api/groups/'+group4+'/clips/'+clip1+'/'+user1+'?access_token='+access_token, function(){
...
/**
 * POST /api/groups/:group_id/clips/:clip_id/:user_id - clip already in group
 */
describe('POST /api/groups/'+group3+'/clips/'+clip1+'/'+user2+'?access_token='+access_token, function(){
...
/**
 * POST /api/groups/:group_id/clips/:clip_id/:user_id - fake group
 */
describe('POST /api/groups/'+fakegroup+'/clips/'+clip1+'/'+user2+'?access_token='+access_token, function(){
...
/**
 * POST /api/groups/:group_id/clips/:clip_id/:user_id - check clip added to group
 */
describe('POST /api/groups/'+group4+'/clips/'+clip1+'/'+user2+'?access_token='+access_token, function(){
  it('should respond with 404 group doesnt exist', function(done){
    request(app)
...
/**
 * GET /api/groups/:group_id/users/:user_id/clips - fake group
 */
describe('GET /api/groups/'+fakegroup+'/users/'+user1+'/clips?access_token='+access_token, function(){
  it('should respond with 404 group not found', function(done){
    request(app)
...
/**
 * GET /api/groups/:group_id/users/:user_id/clips - user not in group 401
 */
describe('GET /api/groups/'+group3+'/users/'+user2+'/clips?access_token='+access_token, function(){
...
/**
 * GET /api/groups/:group_id/users/:user_id/clips - good request empty array
 */
describe('GET /api/groups/'+group2+'/users/'+user1+'/clips?access_token='+access_token, function(){
...
/**
 * GET /api/groups/:group_id/users/:user_id/clips - good request array with clip
 */
describe('GET /api/groups/'+group3+'/users/'+user1+'/clips?access_token='+access_token, function(){
...
/**
 * GET api/groups/:user_id - fake user
 */
describe('GET /api/groups/'+ fakeuser +'?access_token='+access_token, function(){
...
/**
 * GET api/groups/:user_id - good should return 3 groups
 */
describe('GET /api/groups/'+ user1 +'?access_token='+access_token, function(){
...
/**
 *  POST api/groups/:user_id - good - check group exists with name 'Test Group WOW'
 */
describe('POST /api/groups/'+ user1 +'?access_token='+access_token, function(){
...
/**
 *  POST api/groups/:user_id - good - check user added to group
 */
describe('POST /api/groups/'+ user1 +'?access_token='+access_token, function(){
...
/**
 *  POST api/groups/:user_id - good - check group added to user groups
 */
describe('POST /api/groups/'+ user1 +'?access_token='+access_token, function(){
  var newGroup = {};
...
/**
 * DELETE api/groups/:group_id/users/:user_id - fake user
 */
describe('DELETE /api/groups/'+group5+'/users/'+ fakeuser +'?access_token='+access_token, function(){
...
/**
 * DELETE api/groups/:group_id/users/:user_id - user not in group 400 bad request
 */
describe('DELETE /api/groups/'+group5+'/users/'+ user2 +'?access_token='+access_token, function(){
...
/**
 * DELETE api/groups/:group_id/users/:user_id - good request - check user not in group anymore
 */
describe('DELETE /api/groups/'+group6+'/users/'+ user2 +'?access_token='+access_token, function(){
...
/**
 * DELETE api/groups/:group_id/users/:user_id - good request - empty group removed from db
 */
describe('DELETE /api/groups/'+group5+'/users/'+ user1 +'?access_token='+access_token, function(){
...
/**
 * DELETE api/groups/:group_id/clips/:clip_id/users/:user_id - fake user
 */
...
/**
 * DELETE api/groups/:group_id/clips/:clip_id/users/:user_id - user not group
 */
describe('DELETE /api/groups/'+group3+'/clips/'+clip3+'/users/'+ user2 +'?access_token='+access_token, function(){
...
/**
 * DELETE api/groups/:group_id/clips/:clip_id/users/:user_id - fake clip
 */
describe('DELETE /api/groups/'+group3+'/clips/'+fakeclip+'/users/'+ user1 +'?access_token='+access_token, function(){
 ...
 * DELETE api/groups/:group_id/clips/:clip_id/users/:user_id - fake clip
 */
describe('DELETE /api/groups/'+group3+'/clips/'+clip4+'/users/'+ user1 +'?access_token='+access_token, function(){
